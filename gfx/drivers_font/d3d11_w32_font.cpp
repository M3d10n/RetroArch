...
typedef struct
{
   d3d11::DeviceResources *d3d;
   uint32_t color;
} d3dfonts_t;

static void *d3d11fonts_w32_init_font(void *video_data,
      const char *font_path, float font_size)
{
   d3dfonts_t *d3dfonts = NULL;
   d3dfonts = (d3dfonts_t*)calloc(1, sizeof(*d3dfonts));

   d3dfonts->d3d = (d3d11::DeviceResources*)video_data;
...
static void d3d11fonts_w32_free_font(void *data)
{
	/*
...
static void d3d11fonts_w32_render_msg(void *data, const char *msg,
      const void *userdata)
{
	/*
   ...
   auto d2d = d3dfonts->d3d->GetD2DDeviceContext();
   d2d->BeginDraw();
...
font_renderer_t d3d11_win32_font = {
   d3d11fonts_w32_init_font,
   d3d11fonts_w32_free_font,
   d3d11fonts_w32_render_msg,
   "d3d11font",
   NULL,                      /* get_glyph */
   NULL,                      /* bind_block */
   NULL,                      /* flush */
